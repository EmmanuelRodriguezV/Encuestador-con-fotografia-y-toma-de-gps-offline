...
Vue.component('avance-div', {
                    ...
                    <div class="col-md-12 offset-md-0">
                        ...
                        <div class="row" style="padding-top: 40px;">
                            <div class="col-12">
                                ...
                                <div id="tablaactiv" v-if="tablaactiv" class="row" style="padding-top: 40px;">
                                    <div class="col-12">
    ...
    methods: {
        ...
        actualiza_dash: function(){
            ...
            ero = this;
            //De entrada al montar el componente vamos y traemos las solicitudes pendientes o en atención via ajax
            axios.post('index.php/div/infodash/', {div_id:this.div_id, zona_id:this.zona_id, rc_year:this.datos_filtro.rc_year, rc_mes:this.datos_filtro.rc_mes}).then(function (res) {
